        ...
        <>
            ...
            <div className='topBox'>
                <div className='countryBox'>
                    <div className='boxTitle'>Country</div>
                    <div>
                        <Input
                            id="countryInput"
                            type="text"
                        ...
                        />
                        <Button onClick={addCountry} id='countryButton'>Add Country</Button>
                    </div>

                    <div className="getList">
                        <div className="thead">
                            <div className="ct-con">
                                <div className="ct1">안전성</div>
                                <div className="ct1">나라 iso</div>
                                <div className="ct1">나라 이름</div>
                                <div className="ct1">DELETE</div>
                            </div>
                        </div>
                        <div className="tbody">
                            {countrys.map(country => (
                                <div
                                    ...
                                    className={`tr countryItem ${selectedCountry && selectedCountry.countryIso === country.countryIso ? 'active' : ''}`}
                                    onClick={() => handleCountryClick(country.id)}
                                >
                                    <div className="cl1"></div>
                                    <div className="cl1">{country.countryIso}</div>
                                    <div className="cl1">{country.countryName}</div>
                                    <div className="cl1">
                                        <Button onClick={(e) => { e.stopPropagation(); deleteCountry(country.countryIso); }}>
                                            DEL
                                        </Button>
                                    </div>
                                </div>
                ...
                <div className='airportBox'>
                    <div className='boxTitle'>Airport</div>
                    <div>
                        <Input
                            id="airportInput"
                            type="text"
                        ...
                        />
                        <Button onClick={addAirport} id='airportButton'>Add Airport</Button>
                    </div>

                    <div className="getList">
                        <div className="thead">
                            <div className="ct-con">
                                <div className="ct2">공항 Iata</div>
                                <div className="ct2">공항 이름</div>
                                <div className="ct2">DELETE</div>
                            </div>
                        </div>
                        <div className="tbody">
                            {airports.map(airport => (
                                <div key={airport.airportId} className="tr airportItem">
                                    <div className="cl2">{airport.airportIso}</div>
                                    <div className="cl2">{airport.airportName}</div>
                                    <div className="cl2">
                                        <Button onClick={() => deleteAirport(airport.airportIso)}>DEL</Button>
                                    </div>
                                </div>
                            ))}
                        </div>
