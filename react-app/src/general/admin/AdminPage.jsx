    ...
    const AdminPage = () => {
        ...
        return (
            <>
                ...
                />
                <Box className='contentWrapper' position="absolute" top="0" left="0" width="100%" height="100%">
                    ...
                    <Box className='countryBox'>
                        <form onSubmit={addCountry}>
                            ...
                            <div>
                                ...
                                />
                                <Button type="submit" name="search" id='countryButton'>Add Country</Button>
                            </div>
                        </form>
                            ...
                            <tbody>
                                {countrys.map(country => (
                                    <tr
                                        ...
                                        className={`countryItem ${selectedCountry && selectedCountry.countryIso === country.countryIso ? 'active' : ''}`}
                        ...
                        <Box className='airportBox'>
                            <form onSubmit={addAirport}>
                                ...
                                <div>
                                    ...
                                    />
                                    <Button type="submit" name="search" id='airportButton'>Add Airport</Button>
                                </div>
                            </form>
