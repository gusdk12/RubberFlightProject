package com.lec.spring.user.config;

import com.lec.spring.user.jwt.JWTFilter;
import com.lec.spring.user.jwt.JWTUtil;
import com.lec.spring.user.jwt.LoginFilter;
import com.lec.spring.user.jwt.JWTUtil;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        // 웹서비스에서 사용할 수 있는 여러 인증방법들..
        // 폼 인증, Http basic 인증, OAuth2, JWT 등,,
        // 이번 예저에선 JWT 인증을 사용할 것이므로
